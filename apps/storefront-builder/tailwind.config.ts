...
const config: Config = {
  ...
  theme: {
    extend: {
      keyframes: {
        "drop-effect": {
          "0%": { backgroundColor: "yellow", transform: "scale(1)" },
          "100%": { backgroundColor: "lightgreen", transform: "scale(1.05)" },
        },
        flip: {
      ...
      animation: {
        "drop-effect": "drop-effect 1s forwards",
        flip: "flip 0.6s ease-in-out forwards",
        "pop-up": "pop-up 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",
      },
      fontFamily: {
        poppins: ["Poppins"],
      },
