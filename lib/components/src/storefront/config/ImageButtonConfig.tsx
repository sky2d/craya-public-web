...
export const ImageButtonConfig: React.FC<StorefrontComponentConfigProps> = ({ storefrontComponentType, data, setData, onclick, setIndex }) => {
    ...
    <div className="p-2">
      <div className="mt-4 flex flex-col gap-2">
        ...
        <div className="mt-2 flex items-center justify-between gap-2">
          <InputField onChange={handleTextChange} className="border-white-light2" placeholder="Button text" value={data.texts[0]} />
          <Button
            label="Add Products"
            size="small"
            primary
            handelClick={() => handleAddProductButton({ data, setData, onclick, setIndex, storefrontComponentType })}
          />
        </div>
