export default function ShippingPolicy() {
  return (
    <div className="h-full w-full p-6 sm:max-w-[75%]">
      ...
      <div className="mx-auto my-4 max-w-3xl">
        <h2 className="mb-4 text-2xl font-semibold">Delivery Timeframes</h2>
      ...
      <div className="mx-auto my-4 max-w-3xl">
        <h2 className="text-gray-800 mb-6 text-2xl font-semibold">Order Tracking</h2>
      ...
      <div className="mx-auto my-4 max-w-3xl">
        <h2 className="text-gray-800 mb-6 text-2xl font-semibold"> Shipping Costs</h2>
        <p className="text-gray-700 mb-4">
      ...
      <div className="mx-auto my-4 max-w-3xl">
        <h2 className="text-gray-800 mb-6 text-2xl font-semibold"> Delivery Locations</h2>
      ...
      <div className="mx-auto my-4 max-w-3xl">
        <h2 className="text-gray-800 mb-6 text-2xl font-semibold">Custom Seller Shipping Policies</h2>
      ...
      <div className="mx-auto my-4 max-w-3xl">
        <h2 className="text-gray-800 mb-6 text-2xl font-semibold">Delivery Delays & Exceptions</h2>
      ...
      <div className="mx-auto my-4 max-w-3xl">
        <h2 className="text-gray-800 mb-6 text-2xl font-semibold">Returns & Order Issues</h2>
        <p className="text-gray-700 mb-4">
      ...
      <div className="mx-auto my-4 max-w-3xl">
        <h2 className="text-gray-800 mb-6 text-2xl font-semibold">Customer Support</h2>
