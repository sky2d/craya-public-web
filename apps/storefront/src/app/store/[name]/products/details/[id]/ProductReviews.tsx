...
const ProductReviews: React.FC<ProductReviewsProps> = ({ reviews, storeDetails, handleReviewClick }) => {
      ...
      {reviews && reviews.length > 0 ? (
        <div className="w-full flex-col">
          <WhiteBackgroundWrapper className="flex items-start justify-center rounded-2xl shadow-xl">
            <div className="w-1/2">
              <p className="flex items-center justify-center text-7xl font-extrabold" style={{ color: primaryColor }}>
                {calculateAverageRating(reviews).toFixed(1)}
                <span className="mx-1 text-5xl">
          ...
          {review && (
            <div className="rounded-lg p-2 shadow-xl">
              ...
              <p className="flex w-full items-center justify-end text-right text-blue-400 hover:cursor-pointer" onClick={handleReviewClick}>
        ...
        <div className="bg-white flex w-full items-center justify-center rounded-2xl p-6 text-center shadow-lg">
          <div className="flex aspect-square h-full max-h-14 w-full max-w-14 cursor-pointer items-center justify-center rounded-full p-2 hover:shadow-lg">
            <Image src={ReviewImage} draggable={false} alt="Share" className="h-full w-full object-contain" />
          </div>
