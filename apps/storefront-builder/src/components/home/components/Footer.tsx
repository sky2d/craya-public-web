...
import { aboutLinks, contactDetails, infoLinks } from "../../../constant/NavigationLinks";
    ...
    <footer className="text-white w-full snap-end bg-brand-color1 p-6">
      <div className="flex flex-col items-center sm:flex-row sm:justify-between">
        ...
        <div className="flex w-full justify-center sm:justify-start">
          <Image src={Logo} alt="Craya Logo" width={200} height={40} />
        </div>
      ...
      <div className="mt-6 flex flex-col items-center justify-between border-t border-white-light3 pt-4 sm:flex-row">
        ...
        <div className="mt-4 flex space-x-3 sm:mt-0">
          <FaInstagram
            onClick={() => window.open("https://www.instagram.com/craya.shop?igsh=MWw5OTR1eWJqNzJrNw==", "_blank")}
            className="hover:text-gray-300 cursor-pointer text-2xl text-white-light4"
          />
          <FaFacebook
            onClick={() => window.open("https://www.facebook.com/craya.shop", "_blank")}
            className="hover:text-gray-300 cursor-pointer text-2xl text-white-light4"
          />
        </div>
      </div>
